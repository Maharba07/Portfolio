  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <div className="collapse bg-base-200">
        ...
        <div className="collapse-content">
          <p className="text-2xl">
            ...
            perspiciatis illum dolores, architecto hic ullam cupiditate nemo
            dicta accusantium nostrum, impedit culpa dolor molestiae pariatur
            asperiores voluptatibus sit placeat.
          </p>
        </div>
      </div>
      {/* Imagen de Perfil */}
      ...
      <div className="flex w-full flex-col">
        ...
        <br />
        <h2 className="text-blue-500 text-center text-xl font-medium">Email:</h2>
        <a
